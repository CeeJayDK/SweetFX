...
sampler2D BackBuffer
{
	...
	SRGBTexture = SWEETFX_TC_SRGB && (BUFFER_COLOR_SPACE==1) && (BUFFER_COLOR_BIT_DEPTH==8);
};
...
technique Technicolor
{
	pass
	{
		...
		SRGBWriteEnable = SWEETFX_TC_SRGB && (BUFFER_COLOR_SPACE==1) && (BUFFER_COLOR_BIT_DEPTH==8);
	}
}
